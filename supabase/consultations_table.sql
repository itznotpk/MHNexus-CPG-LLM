...
GRANT EXECUTE ON FUNCTION save_consultation_bypass(TEXT, TEXT, DATE, JSONB) TO anon;
GRANT EXECUTE ON FUNCTION save_consultation_bypass(TEXT, TEXT, DATE, JSONB) TO authenticated;
